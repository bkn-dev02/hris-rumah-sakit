...
<div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
    ...
    <div class="sm:col-span-2">
        ...
        <textarea name="description" rows="2"
            class="w-full rounded-lg border border-slate-200 py-2 px-3 text-sm focus:border-[#2a684f] focus:outline-none focus:ring-1 focus:ring-[#dfeee1]">{{ old('description', $role->description ?? '') }}</textarea>
    </div>
