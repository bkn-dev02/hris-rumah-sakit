...
<div class="max-w-7xl mx-auto px-6 py-8">
    <div class="flex items-center gap-4">
        ...
        <h1 class="text-xl font-semibold text-[#1f4d3d]">Tambah Permission</h1>
    </div>
    ...
    <form method="POST" action="{{ route('security.permissions.store') }}" class="mt-6 bg-white shadow-md p-6">
        ...
        <div class="mt-6 flex justify-end gap-3">
            ...
            <button type="submit" class="bg-[#1f4d3d] hover:bg-[#2a684f] text-white px-5 py-2 rounded-full text-sm font-medium transition duration-200">Simpan</button>
        </div>
    </form>
</div>
@endsection
