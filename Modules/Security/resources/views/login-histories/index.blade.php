...
<div class="max-w-7xl mx-auto px-6 py-8">
    ...
    <div class="flex items-center gap-4">
        ...
        <h1 class="text-xl font-semibold text-blue-800">Riwayat Login</h1>
    </div>

    <form method="GET" class="mt-6 flex flex-wrap items-end gap-3">
        <div>
            <label class="mb-1 block text-xs font-medium text-slate-500">Status</label>
            <select name="status" class="rounded-lg border border-slate-200 py-2 px-3 text-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500">
        ...
        <a href="{{ route('security.login-histories.index') }}" class="text-sm text-slate-500 hover:text-blue-600">Reset</a>
        @endif
    </form>
