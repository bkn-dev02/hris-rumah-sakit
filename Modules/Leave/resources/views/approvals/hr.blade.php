...
@section('title', 'Approval Cuti â€” HRD')

@section('content')
<div class="max-w-5xl mx-auto px-6 py-8">
    <div class="mb-6 rounded-xl bg-[#edf5ee] px-5 py-4 shadow-sm">
        <h1 class="text-xl font-bold text-[#173f34]">Approval Cuti (HRD)</h1>
            ...
            <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <div>
                    ...
                    <p class="mt-1 text-xs text-slate-400">
                        ...
                        @if ($leaveRequest->supervisor_note) â€” "{{ $leaveRequest->supervisor_note }}" @endif
                    </p>
                    @endif
                </div>
