        ...
        <div class="rounded-xl border border-[#dfeee1] bg-white p-5 shadow-sm">
            <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div class="flex gap-2">
                    <form action="{{ route('leave.decide-supervisor', $leaveRequest->id) }}" method="POST" onsubmit="return confirm('Setujui pengajuan ini?');">
                        @csrf
                    ...
                    <form action="{{ route('leave.decide-supervisor', $leaveRequest->id) }}" method="POST" onsubmit="return confirm('Tolak pengajuan ini?');">
                        @csrf
