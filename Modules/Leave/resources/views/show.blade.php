...
<div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:py-8">
    ...
    <div>
        ...
        <a href="{{ Storage::disk('public')->url($leaveRequest->attachment) }}" target="_blank"
            class="inline-flex items-center gap-2 text-sm font-medium text-sky-700 hover:underline">
