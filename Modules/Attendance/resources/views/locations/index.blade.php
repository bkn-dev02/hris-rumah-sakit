...
<div class="max-w-7xl mx-auto px-6 py-8">
    ...
    <div class="flex items-center justify-between">
        <div class="flex items-center gap-4">
            ...
            <h1 class="text-xl font-semibold text-blue-800">Lokasi Absensi</h1>
        </div>
        <a href="{{ route('attendance.locations.create') }}" class="bg-blue-900 hover:bg-blue-800 text-white px-4 py-2 rounded-full text-sm font-medium transition duration-200">
    ...
    <div class="mt-6 bg-white shadow-md p-4">
        ...
        <div class="border border-gray-200 rounded-md grid grid-cols-5 gap-4 p-4 items-center text-gray-700 text-sm">
            ...
            <span class="text-slate-500">{{ $location->latitude }}, {{ $location->longitude }}</span>
            ...
            <div class="grid grid-cols-2 gap-2 w-full">
                <a href="{{ route('attendance.locations.edit', $location->id) }}" class="bg-blue-900 hover:bg-blue-800 text-white rounded-full px-3 py-1 transition duration-200 flex items-center justify-center gap-1 hover:-translate-y-1 hover:shadow-lg">
        ...
        @empty
        <div class="border border-gray-200 rounded-md p-10 text-center text-sm text-slate-400">Belum ada lokasi absensi.</div>
        @endforelse
    </div>
