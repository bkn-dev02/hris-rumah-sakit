...
<div class="max-w-7xl mx-auto px-6 py-8">
    ...
    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div class="w-full flex justify-between items-center">
            <div class="flex items-center gap-4">
                ...
                <h1 class="text-xl font-semibold text-[#1f4d3d]">Status Kepegawaian</h1>
            </div>
            <div class="transition duration-200 translate-y-0 hover:-translate-y-1 hover:shadow-lg">
                <a href="{{ route('master.employment-statuses.create') }}" class="bg-[#173f34] hover:bg-[#173f34] text-white px-4 py-2 rounded-full transition duration-200">
    ...
    <div class="mt-4 bg-white shadow-md p-4">
        <div class="border border-[#dfeee1] rounded-md grid grid-cols-4 gap-4 p-4 text-[#edf5ee] bg-[#2a684f] mb-2 font-semibold">
            <span>Nama</span>
            <span>Kode</span>
            <span>Status</span>
        ...
        <div class="border border-[#dfeee1] rounded-md grid grid-cols-4 gap-4 p-4 items-center text-[#2a684f]">
            ...
            <div class="grid grid-cols-2 gap-2 w-full">
                <a href="{{ route('master.employment-statuses.edit', $employmentStatus->id) }}" class="bg-[#173f34] hover:bg-[#173f34] text-white rounded-full px-3 py-1 transition duration-200 flex items-center justify-center gap-1 text-center hover:-translate-y-1 hover:shadow-lg">
        ...
        @empty
        <div class="border border-[#dfeee1] rounded-md p-10 text-center text-sm text-slate-400">
