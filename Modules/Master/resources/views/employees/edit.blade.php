...
<div class="max-w-7xl mx-auto px-6 py-8">
    <div class="flex items-center gap-4">
        ...
        <h1 class="text-xl font-semibold text-blue-800">Edit Employee</h1>
    </div>
    ...
    <form method="POST" action="{{ route('master.employees.update', $employee->slug) }}" enctype="multipart/form-data" class="mt-6 bg-white shadow-md p-6">
        ...
        <div class="mt-6 flex justify-end gap-3">
            ...
            <button type="submit" class="bg-blue-900 hover:bg-blue-800 text-white px-5 py-2 rounded-full text-sm font-medium transition duration-200">
                Simpan Perubahan
            </button>
        </div>
    </form>
