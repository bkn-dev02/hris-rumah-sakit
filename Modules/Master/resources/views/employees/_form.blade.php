...
<div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
    ...
    <div class="sm:col-span-2">
        <label class="mb-1 block text-sm font-medium text-[#1f4d3d]">Akun User</label>
        <select name="user_id" class="w-full rounded-lg border border-[#dfeee1] py-2 px-3 text-sm focus:border-[#2a684f] focus:outline-none focus:ring-1 focus:ring-[#dfeee1]">
    ...
    <div>
        <label class="mb-1 block text-sm font-medium text-[#1f4d3d]">Nomor Induk Pegawai</label>
    ...
    <div>
        <label class="mb-1 block text-sm font-medium text-[#1f4d3d]">Nama Lengkap</label>
    ...
    <div>
        <label class="mb-1 block text-sm font-medium text-[#1f4d3d]">Jenis Kelamin</label>
        <select name="gender" class="w-full rounded-lg border border-[#dfeee1] py-2 px-3 text-sm focus:border-[#2a684f] focus:outline-none focus:ring-1 focus:ring-[#dfeee1]">
    ...
    <div>
        <label class="mb-1 block text-sm font-medium text-[#1f4d3d]">Status Kepegawaian</label>
        <select name="employment_status_id" class="w-full rounded-lg border border-[#dfeee1] py-2 px-3 text-sm focus:border-[#2a684f] focus:outline-none focus:ring-1 focus:ring-[#dfeee1]">
    ...
    <div>
        <label class="mb-1 block text-sm font-medium text-[#1f4d3d]">Tanggal Bergabung</label>
    ...
    <div>
        <label class="mb-1 block text-sm font-medium text-[#1f4d3d]">Tempat Lahir</label>
    ...
    <div>
        <label class="mb-1 block text-sm font-medium text-[#1f4d3d]">Tanggal Lahir</label>
    ...
    <div>
        <label class="mb-1 block text-sm font-medium text-[#1f4d3d]">Profesi</label>
    ...
    <div>
        <label class="mb-1 block text-sm font-medium text-[#1f4d3d]">NIK</label>
    ...
    <div>
        <label class="mb-1 block text-sm font-medium text-[#1f4d3d]">Status Pernikahan</label>
        <select name="marital_status" class="w-full rounded-lg border border-[#dfeee1] py-2 px-3 text-sm focus:border-[#2a684f] focus:outline-none focus:ring-1 focus:ring-[#dfeee1]">
            <option value="">-- Pilih --</option>
    ...
    <div>
        <label class="mb-1 block text-sm font-medium text-[#1f4d3d]">Telepon</label>
    ...
    <div>
        <label class="mb-1 block text-sm font-medium text-[#1f4d3d]">Pendidikan Terakhir</label>
    ...
    <div>
        <label class="mb-1 block text-sm font-medium text-[#1f4d3d]">Jurusan</label>
    ...
    <div class="sm:col-span-2">
        <label class="mb-1 block text-sm font-medium text-[#1f4d3d]">Alamat</label>
        <textarea name="address" rows="2" class="w-full rounded-lg border border-[#dfeee1] py-2 px-3 text-sm focus:border-[#2a684f] focus:outline-none focus:ring-1 focus:ring-[#dfeee1]">{{ old('address', $employee->address ?? '') }}</textarea>
        @error('address') <p class="mt-1 text-xs text-red-600">{{ $message }}</p> @enderror
    </div>

    <div class="sm:col-span-2">
        <label class="mb-1 block text-sm font-medium text-[#1f4d3d]">Foto</label>
        <input type="file" name="photo" accept="image/*"
            class="w-full rounded-lg border border-[#dfeee1] py-2 px-3 text-sm file:mr-3 file:rounded-md file:border-0 file:bg-[#edf5ee] file:px-3 file:py-1.5 file:text-sm file:font-medium file:text-[#1f4d3d] hover:file:bg-[#dfeee1]">
    ...
    <div class="flex items-center gap-2 sm:col-span-2">
        ...
        <label for="is_active" class="text-sm text-[#1f4d3d]">Employee aktif</label>
    </div>
