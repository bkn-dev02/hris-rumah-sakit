<div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
    <div>
        <label class="mb-1 block text-sm font-medium text-sky-700">Nama Position</label>
    ...
    <div>
        <label class="mb-1 block text-sm font-medium text-sky-700">Level Jenjang</label>
        <input type="number" name="level" min="1" value="{{ old('level', $position->level ?? '') }}"
            class="w-full rounded-lg border border-sky-200 py-2 px-3 text-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500">
        <p class="mt-1 text-xs text-sky-400">Angka lebih besar = jenjang lebih tinggi. Dipakai sistem untuk menentukan promosi/demosi otomatis.</p>
    ...
    <div class="flex items-center gap-2">
        ...
        <label for="is_active" class="text-sm text-sky-700">Position aktif</label>
    </div>
</div>